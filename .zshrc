...
alias hstop="/usr/local/Cellar/hadoop/3.1.1/sbin/stop-dfs.sh;/usr/local/Cellar/hadoop/3.1.1/sbin/stop-yarn.sh"
export STREAM="/usr/local/Cellar/hadoop/3.1.1/libexec/share/hadoop/tools/lib/hadoop-streaming-3.1.1.jar"
